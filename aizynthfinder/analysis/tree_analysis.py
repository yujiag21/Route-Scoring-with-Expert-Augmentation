...
class TreeAnalysis:
    ...
    def sort(
        ...
        if isinstance(self.search_tree, MctsSearchTree):
            ...
            # sorted_items, sorted_scores, _, all_score = self.scorer.sort(nodes)
        ...
        # return self._collect_top_items(sorted_items, sorted_scores, all_score, actions, selection)
    ...
    def _collect_top_items(
        ...
        last_score = 1e16
        best_all_score=[]
        for score, item, actions in zip(scores, items, reactions): #all_score
            ...
            # best_all_score.append(score_list)
            last_score = score
        ...
        return best_items, best_scores #, best_all_score
