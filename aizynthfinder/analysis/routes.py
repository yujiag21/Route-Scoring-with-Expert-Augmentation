...
class RouteCollection:
    ...
    def __init__(self, reaction_trees: Sequence[ReactionTree], **kwargs) -> None:
        ...
        self.original_nodes = self._unpack_kwarg_with_default("original_nodes", None, **kwargs)
        ...
        self.all_score = self._unpack_kwarg_with_default("all_score", dict, **kwargs)
    ...
    def from_analysis(
        ...
        """
        # items, scores, all_score = analysis.sort(selection)
        # all_scores = [{repr(analysis.scorer): score} for score in scores]
        # if isinstance(all_score[0],float):89
        #     kwargs = {"scores": scores, "all_scores": all_scores}
        # else:
        #     all_score = [{"cost": scores[0], "stability": scores[1], "feasibility": scores[2]} for scores in all_score]
        #     kwargs = {"scores": scores, "all_scores": all_scores, "all_score": all_score}
